...
-  nativefier --icon "icon/path/from/local/or/remotly/imageName.ico" "https://domain.com" <!-- With Custome Icon -->
...
-  ssh-keygen -t rsa -b 4096 -C ["github_mail@gmail.com"] <!-- Create A New SSH Key -->
